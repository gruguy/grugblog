    ...
    <el-card>
      <template #header>
        <div class="card-header">
          <span>音乐管理</span>
          <el-button type="primary" @click="openUploadDialog">上传音乐</el-button>
        </div>
      </template>
      ...
      <el-table :data="musicList" stripe style="width: 100%">
        ...
        <el-table-column label="操作" width="150" fixed="right">
          <template #default="scope">
            ...
            <el-button type="danger" size="small" @click="deleteMusic(scope.row.id)">
              删除
            </el-button>
          </template>
        </el-table-column>
      ...
      <el-dialog
        ...
        width="500px"
      >
        <el-form :model="musicForm" label-width="80px" :rules="rules" ref="formRef">
          <el-form-item label="名称" prop="name">
            <el-input v-model="musicForm.name" placeholder="请输入音乐名称" />
          </el-form-item>
          
          <el-form-item label="艺术家" prop="artist">
            <el-input v-model="musicForm.artist" placeholder="请输入艺术家名称" />
          </el-form-item>
          ...
          <el-form-item label="封面">
            <el-upload
              ...
              accept="image/*"
            >
              <img v-if="musicForm.cover" :src="musicForm.cover" class="avatar" />
...
import { getMusicList, createMusic, updateMusic, deleteMusic as deleteMusicApi } from '../api/music'
