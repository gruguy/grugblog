    ...
    <el-card>
      ...
      <el-table :data="videoList" stripe style="width: 100%">
        ...
        <el-table-column label="操作" width="150" fixed="right">
          <template #default="scope">
            <el-button type="primary" size="small" @click="editVideo(scope.row)">
              编辑
            </el-button>
            <el-button type="danger" size="small" @click="deleteVideo(scope.row.id)">
              删除
            </el-button>
          </template>
        </el-table-column>
      ...
      <el-dialog
        ...
        width="500px"
      >
        <el-form :model="videoForm" label-width="80px" :rules="rules" ref="formRef">
...
import { getVideoList, createVideo, updateVideo, deleteVideo as deleteVideoApi } from '../api/video'
