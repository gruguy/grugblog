          ...
          <ul class="space-y-1">
            ...
            >
              <div class="flex items-center gap-2 flex-1">
                <svg v-if="selectedCategoryId === null" class="w-4 h-4 text-blue-500" fill="currentColor" viewBox="0 0 24 24">
              ...
              <span :class="[
                'text-xs',
                selectedCategoryId === null ? 'text-blue-500' : 'text-muted-foreground'
              ]">{{
                totalArticlesCount
              }}</span>
            </li>
            ...
            >
              <div class="flex items-center gap-2 flex-1">
                <svg v-if="selectedCategoryId === category.id" class="w-4 h-4 text-blue-500" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" />
                </svg>
              ...
              <span :class="[
                'text-xs',
                selectedCategoryId === category.id ? 'text-blue-500' : 'text-muted-foreground'
              ]">{{
                ...
                <div class="flex flex-col md:flex-row gap-4">
                  ...
                  <div class="flex-1">
                    ...
                    <p class="text-muted-foreground mb-4 line-clamp-2">
                      {{ article.summary || article.content.replace(/<[^>]+>/g, "").substring(0, 50) + (article.content.replace(/<[^>]+>/g, "").length > 50 ? "..." : "") }}
                    </p>
                    <div
